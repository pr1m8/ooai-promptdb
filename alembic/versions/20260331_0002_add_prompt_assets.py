...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column(
            'storage_backend', sa.String(length=64), nullable=False,
        ),
        sa.Column('bucket', sa.String(length=255), nullable=False),
        sa.Column(
            'object_key', sa.String(length=1024), nullable=False,
        ),
        sa.Column(
            'content_type', sa.String(length=255), nullable=True,
        ),
        sa.Column('byte_size', sa.Integer(), nullable=True),
        sa.Column(
            'checksum_sha256', sa.String(length=64), nullable=True,
        ),
...
def downgrade() -> None:
    ...
    op.drop_index(
        'ix_prompt_assets_version_id', table_name='prompt_assets',
    )
